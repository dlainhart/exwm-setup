...
[[https://github.com/emacs-exwm/exwm][EXWM]] (Emacs X Window Manager) is a full-featured tiling X window manager for
Emacs built on top of [[https://github.com/emacs-exwm/xelb][XELB]].
...
- You do not have to do it this way, for example:
  ...
  - Do you want emacs to handle everything, as is done here, or instead let
    ...
    or [[https://github.com/emacs-exwm/exwm/wiki/Installation-on-macOS][XQuartz under macOS]]?
...
what is published [[https://github.com/emacs-exwm/exwm/wiki/Installation-on-macOS][here]]. Or under LXDE or Gnome, or with a composite manager.
...
[[https://github.com/emacs-exwm/exwm/blob/master/exwm-config.el]], changing the names
